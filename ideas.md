...
-   *Razão*: Evoca manuais técnicos de alta precisão e interfaces de engenharia.
...
-   **Hierarquia**:
    -   Display: Inter Tight, Weight 700, Tracking -0.02em.
...
-   *Razão*: Reflete a natureza "hacker" e "underground" do Arch Linux e manipulação de hardware.
